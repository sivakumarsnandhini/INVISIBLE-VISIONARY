...
import { USER_CREATION, PRODUCT_CREATION } from '../../Api'
...
function CustomEditComponent(props) {
    ...
    if (filter === 'year') {
        ...
        list = data.map((val, i) => {
            ...
            const dateString = "Fri Feb 02 2024 05:30:00 GMT+0530";
        ...
        list = data.map((val, i) => {
            const currentItem = item[i] || {};
            const itemDate = currentItem.date;
                            ...
                            <div>
                                ...
                                {show && (
                                    <div style={{
                                        ...
                                        <a style={{ color: "black" }} className="dropdown-item" onClick={() => { setfilter('year') }}>
                                            Yearly
                                        </a>
                                        <a style={{ marginTop: "10px", color: "black" }} className="dropdown-item" onClick={() => { setfilter('month') }} >
                                            Monthly
                                        </a>
                                        <a style={{ marginTop: "10px", color: "black" }} className="dropdown-item" onClick={() => { setfilter('week') }} >
                                            Weekly
                                        </a>
                                    </div>
                                )}
